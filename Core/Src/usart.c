...
//涓插彛1涓柇鏈嶅姟绋嬪簭
//娉ㄦ剰,璇诲彇USARTx->SR鑳介伩鍏嶈帿鍚嶅叾濡欑殑閿欒   	
u8 USART_RX_BUF[USART_REC_LEN];     //鎺ユ敹缂撳啿,鏈€澶SART_REC_LEN涓瓧鑺�.
//鎺ユ敹鐘舵€�
//bit15锛�	鎺ユ敹瀹屾垚鏍囧織
//bit14锛�	鎺ユ敹鍒�0x0d
//bit13~0锛�	鎺ユ敹鍒扮殑鏈夋晥瀛楄妭鏁扮洰
u16 USART_RX_STA=0;       //鎺ユ敹鐘舵€佹爣璁�	
...
{ 
	...
	timeout=0;
	while(HAL_UART_Receive_IT(&huart1,(u8 *)aRxBuffer, RXBUFFERSIZE)!=HAL_OK)//涓€娆″鐞嗗畬鎴愪箣鍚庯紝閲嶆柊寮€鍚腑鏂苟璁剧疆RxXferCount涓�1
	{
        timeout++; //瓒呮椂澶勭悊
        if(timeout>maxDelay) break;	
	}
